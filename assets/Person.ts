...
export class Person {
  ...
  constructor(parent_1?: Person, parent_2?: Person, age: number = 0, homosexual: boolean = false, donor: boolean = false, year: number = 0, gender?: Gender) {
  ...
  private setAlleles(parent_1?: Person, parent_2?: Person): void {
    if (parent_1 && parent_2) {
      ...
      if (this.homosexual == true) {
        ...
        if (CONFIG.init_all_heterosexual == false) {
                ...
                if (this.gwas['rs28371400-15q21.3']['allele']['two'] == 'r') {
                  ...
                  if (this.gwas['rs34730029-11q12.1']['allele']['one'] == 'r') {
                    if (this.gwas['rs34730029-11q12.1']['allele']['two'] == 'r') {
                      if (!CONFIG.homosexual_only_chance) {
                        this.homosexual = true;
                      } else {
                        this.homosexual = (Math.random() <= CONFIG.homosexual_only_chance_percent) ? true : false;
                      }
                    }
                  }
                }
  ...
  private lawOfSeggregation(gene_1: Allele, gene_2: Allele): Allele {
    // [ ][R] [R]
    // [R][RR][RR]
    // [R][RR][RR]
  ...
  private randomAlleleHeterosexual(): Allele {
  ...
  public getGender(): Gender {
    ...
    throw new Error("Gender-less person");
  }
